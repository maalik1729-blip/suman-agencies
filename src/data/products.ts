...
export const products: Product[] = [
  ...
  // --- ELECTRONICS: HOME APPLIANCES ---
  {
    ...
    description: "The Samsung Bespoke AI 1.5 Ton 5-Star Inverter Split AC uses artificial intelligence to auto-adjust cooling for optimal comfort and energy savings. Wind-Free technology delivers gentle air circulation without direct cold drafts. BEE 5-Star rated for 2026, with Wi-Fi control via the SmartThings app and a comprehensive 5-year warranty.",
  ...
  },
  {
    ...
    description: "The Voltas 2025 model 1.5 Ton Hot & Cold Split Inverter AC keeps you comfortable year-round — fast, energy-efficient cooling in summer and steady heating in winter. The anti-dust filter and copper condenser ensure long-lasting, low-maintenance performance.",
  ...
  },
  {
    ...
    description: "The Usha Striker 400mm table fan delivers strong, steady airflow with a 3-speed control and wide automatic oscillation. A thermal overload protector ensures safe long-term use. Compact and reliable for personal cooling in bedrooms, desks, and offices.",
  ...
  },
  {
    ...
    description: "The Crompton Caelum 1200mm BLDC ceiling fan is engineered for maximum energy efficiency, consuming significantly less power than conventional fans. Comes with both a wireless remote and a physical regulator for flexible speed control. Finished in a sleek grey tone with a 4-year manufacturer warranty.",
  ...
  },
  {
    ...
    description: "The Orient Electric Ujala Prime BLDC ceiling fan runs on just 28W, making it highly inverter-compatible for uninterrupted comfort during power cuts. Includes a smart remote with 5-speed settings, a reverse mode for winter circulation, and a timer function — all wrapped in a clean white finish.",
  ...
  },
  {
    ...
    description: "The Havells 52-litre room air cooler is built for powerful cooling in medium to large rooms. Honeycomb cooling pads improve evaporation efficiency, and the large water tank ensures long run times between refills. Inverter-compatible and easy to move on castor wheels.",
